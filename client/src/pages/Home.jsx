    ...
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
      ...
      <div className=' flex-1 px-6 py-20'>
        ...
        <div className=' flex justify-center mb-6'>
          <div className=' bg-gray-100 text-gray-600 font-semibold text-sm px-4 py-2 rounded-full flex items-center gap-2'>
            <HiSparkles size={22} className=' bg-gray-100 text-green-600' />
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                },
                {
                  ...
                  desc: "Dynamic follop-up questions based on your answers."
                },
                {
                ...
                className= {`relative bg-white rounded-3xl border-2 border-gray-100 hover:border-green-500 p-10 w-80 max-w-sm md:max-w-md shadow-md hover:shadow-2xl 
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  {
                    image: evalImg,
                    icon: <BsBarChart size={30}/>,
                    title: "AI Answer Evaluation",
                    desc: "Scores communication, technical accuracy and confidence",
                  },
                  {
                    image: resumeImg,
                    icon: <BsFileEarmarkText size={30}/>,
