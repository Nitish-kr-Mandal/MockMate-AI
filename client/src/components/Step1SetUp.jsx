      ...
      <div className=' w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        className=' relative bg-linear-to-br from-green-50 to-green-100 p-12 flex flex-col justify-center'>
          ...
          <p className='text-gray-600 mb-10'>
            Practice real interview scenarios powered by AI. Improve your communication, technical skills, and confidence.
          </p>
        ...
        className='p-12 bg-white'>
          ...
          <div className='space-y-6'>
            <div className='relative'>
              ...
              className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-400 outline-none transition'
            ...
            <div className='relative'>
              ...
              whileHover={{scale: 1.03}}
              whileTap={{scale: 0.95}} 
              className='w-full disabled:bg-gray-500 bg-green-600 hover:bg-green-700 text-white py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md'>
                Start Interview 
              </motion.button> 
